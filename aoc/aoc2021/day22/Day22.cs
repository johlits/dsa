...
public class Day22
{
    private static long ExecuteCommands(IEnumerable<Command> commands)
    {
    ...
    private static IEnumerable<Command> Parse(IEnumerable<string> input)
    {
    ...
    {
        var input = Parse(File.ReadLines("p.in")).ToList().AsReadOnly();
